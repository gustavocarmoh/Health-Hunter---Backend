...
export class InitialSchema1786317798713 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_rank_level_enum" AS ENUM('E', 'D', 'C', 'B', 'A', 'S')`);
        await queryRunner.query(`CREATE TYPE "public"."users_lifestyle_enum" AS ENUM('Casual', 'Atleta', 'Hardcore')`);
        ...
        await queryRunner.query(`CREATE TABLE "hunter_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "item_id" uuid NOT NULL, "purchased_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_43b4eddc444025541a977dc0acd" UNIQUE ("user_id", "item_id"), CONSTRAINT "PK_df1974ee79c42c7a8163e4db69b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_347642fa2ca1f46b2f18fc9868" ON "hunter_items" ("user_id") `);
        await queryRunner.query(`CREATE TYPE "public"."guilds_rank_enum" AS ENUM('E', 'D', 'C', 'B', 'A', 'S')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c73ea2179a942e79917b8ba3c1" ON "guilds" ("tag") `);
        await queryRunner.query(`CREATE TYPE "public"."guild_members_role_enum" AS ENUM('MASTER', 'VICE_MASTER', 'ELITE', 'MEMBER')`);
        await queryRunner.query(`CREATE TABLE "guild_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "guild_id" uuid NOT NULL, "user_id" uuid NOT NULL, "role" "public"."guild_members_role_enum" NOT NULL DEFAULT 'MEMBER', "contribution_xp" integer NOT NULL DEFAULT '0', "joined_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_a083ac21e0471c1235b0325cc70" UNIQUE ("guild_id", "user_id"), CONSTRAINT "PK_d8df14c1079fd625f782c4f933c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e2b1e7c3e8dff7e78e91c9b101" ON "guild_members" ("user_id") `);
        await queryRunner.query(`CREATE TYPE "public"."guild_invites_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'DECLINED', 'EXPIRED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_4d02303b566c9bc0104a6b1c14" ON "guild_invites" ("invited_user_id", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d5bfb647637e97f70a8316ccd4" ON "challenge_participations" ("user_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_c49454aef596e6f9dc3eb64f3c" ON "audit_logs" ("target_user_id") `);
        await queryRunner.query(`CREATE TABLE "ai_conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "title" character varying(255), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_60db12765b82858ba00c8aa4ae2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."ai_messages_role_enum" AS ENUM('user', 'assistant')`);
        await queryRunner.query(`CREATE TABLE "ai_messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "conversation_id" uuid NOT NULL, "role" "public"."ai_messages_role_enum" NOT NULL, "content" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a390434d4a515ba18a41bc996c2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_45317fda612ccee2aea4352835" ON "activity_logs" ("user_id", "logged_at") `);
